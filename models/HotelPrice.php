...
class HotelPrice extends Model
{
    ...
    public function rules()
    {
        return[
            // rule edit
            [['id', 'rtypeId', 'regularPrice', 'holidayPrice', 'extrabedPrice', 'breakfastPrice', 'adminId'], 'required', 'on' => ['scenarioEditPrice']],
            // rule add
            [['rtypeId', 'regularPrice', 'holidayPrice', 'extrabedPrice', 'breakfastPrice', 'adminId'], 'required', 'on' => ['scenarioAddPrice']]
        ];
...
//  ---------------------------------------- ADD PRICE ----------------------------------------
    ...
    public function addPrice()
    {
        ...
        $sql = "
                BEGIN
                    ...
                    (
                        ...
                        in_extrabed_price            => :extrabedPrice,
        ...
        $st->bindParam(':extrabedPrice', $this->extrabedPrice);
    ...
    public function getPrice()
    {
        ...
        $sql = "
                ...
                FROM 
                    HIZ_HOTEL_PRICE P
                LEFT JOIN 
                    HIZ_HOTEL_RTYPE R ON P.RTYPE_ID = R.ID
                WHERE 
                    P.status = 1
                ORDER BY
                    R.NAME";
