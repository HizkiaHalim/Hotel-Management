<div class="site-index my-5">
    <div class="container col-10">
        <div class="fs-3 text-center p-3 fw-bold"><?= Yii::t('app', 'Hotel Report') ?></div>
...
<script>
    $(function()
    {
                    ...
                    if (dateTrans <= dateSearch)
                    {
                        $("#transactionList").append("\
                                <tr class=\"text-center\">\
                                    ...
                                    <td class=\"align-middle col-1\">" + transList[numcount].TRANSACTION_DATE + "</td>\
                                    <td class=\"align-middle col-1\">" + transList[numcount].BOOK_BY + "</td>\
                                    <td class=\"align-middle col-2\">" + transList[numcount].BOOKER_PHONE + "</td>\
                                    <td class=\"align-middle col-2\">" + transList[numcount].CHECK_IN + "</td>\
                                    <td class=\"align-middle col-2\">" + transList[numcount].CHECK_OUT + "</td>\
                                    <td class=\"align-middle col-1\">" + transList[numcount].BOOK_QTY + "</td>\
                                    <td class=\"align-middle col-1\">" + transList[numcount].TOTAL_PRICE + "</td>\
                                    <td class=\"align-middle col-1\">" + transList[numcount].PAYMENT_NAME + "</td>\
                                    <td class=\"align-middle col-3 text-break\">" + transList[numcount].ROOM_NAME + "</td>\
                                    <td class=\"align-middle col-1\"><button type='button' class='viewTrans btn btn-primary' data-bs-toggle='modal' data-bs-target='#viewTrans' value=" + numcount + ">View</button></td>\
                                </tr>")
                        numcount++;
                    }
                }
        ...
        $("#transactionList").on('click', '.viewTrans', function()
        {
            ...
            extrabed = transList[selection].EXTRABED_QTY.split(',');
            ...
            for (let i = 0; i < rName.length; i++) 
            {
                ...
                totalPrice = 0, price = 0, extrabedprice = "", breakfastprice = "", holiday = 0, normal = 0, holidayprice = "", normalprice = "";
                ...
                $("#roomListSummaryEdit").append("\
                                        <div class=\"border border-4 border-dark rounded mt-2 p-3\">\
                                            ...
                                            <div><?= Yii::t('app', 'Aditional') ?> : " + extrabed[i] + " <?= Yii::t('app', 'extrabed') ?> & " + breakfast[i] + " <?= Yii::t('app', 'breakfast') ?></div>\
            ...
            $("#totalPriceTextEdit").html(' Total Price : IDR ' + transList[selection].TOTAL_PRICE);
