<div class="site-index my-5">
    <div class="container col-10">
        <div class="fs-3 text-center p-3 fw-bold"><?= Yii::t('app', 'Hotel Booking List') ?></div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div>
                            ...
                            <div class="invalid-feedback"><?= Yii::t('app', 'Please input booker name.') ?></div>
                    ...
                    <table class="table table-bordered w-100 my-2 mb-5">
                        <thead>
                            <tr class="text-center">
                                ...
                                <th class="align-middle col-1"><?= Yii::t('app', 'Extrabed Price') ?></th>
        ...
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="pt-2"><?= Yii::t('app', 'Room') ?></div>
                    <div id="roomSelected">
                    </div>
                </div>
                <div class="modal-footer">
...
<script>
    $(function()
    {
        ...
        var selectedRtype = [], selectingRoom, currentSelect, roomselected, roomtypeselected, floorselected, roomInFloorWithStatus, totalPrice = 0, checkin, checkout, selectedRoomId = [], extrabedArr = [], breakfastArr = [], priceArr = [], selection, floorForMap = [], limiter = 1;
        ...
        //no booking if empty logic
            ...
            $("#addBtn").on('click', function()
            {
                ...
                for (let i = 0; i < floorListAll.length; i++) 
                {
                    ...
                    if (floorListAll[i].ROOM != null && lengroom != floorListAll[i].QTY) 
                    {
                ...
                for (let i = 0; i < rtypeAvbInFloor.length; i++)
                {
                    $("#avbList").append("\
                                    <tr class=\"text-center\">\
                                        ...
                                        <td class=\"align-middle col-2\">" + rtypeAvbInFloor[i].EXTRABED_PRICE + "</td>\
        ...
        //submitAddBookingDetail logic
            ...
            $("#submitAddBookingDetail").on('click', function()
            {
                ...
                if ($("#name").val() == "" || $("#phone").val() == "" || $("#checkinDate").val() == "" || $("#checkoutDate").val() == "" || $("#roomQty").val() == "" ) 
                {
                ...
                for (let i = 0; i < $("#roomQty").val(); i++) 
                {
                    ...
                    $("#roomList").append("\
                                    <div class=\"border border-4 border-dark rounded mt-2 p-3\">\
                                        ...
                                        <label for=\"extrabedQty" + roomIndexInArr + "\" class=\"form-label pt-2\"><?= Yii::t('app', 'Extrabed Quantity') ?></label>\
                                        <input type=\"numeric\" class=\"form-control\" id=\"extrabedQty" +  roomIndexInArr + "\" placeholder=\"<?= Yii::t('app', 'Enter Extrabed Quantity') ?>\">\
                                    </div>\
                                ");
                    $("#roomType" + (i+1)).val(selectedRtype[i]);
                    $("#breakfastQty" +  roomIndexInArr).val(0);
                    $("#extrabedQty" +  roomIndexInArr).val(0);
                }
                $("#formAddDetail").modal('toggle');
        ...
        //submitAddBookingRoom logic
            ...
            {
                selectedRoomId = [], extrabedArr = [], breakfastArr = [], priceArr = [], totalPrice = 0; 
                            ...
                            for (let j = 0; j < rName.length; j++) 
                            {
                                if (rStatus[j] == 'selected') 
                                {
                                    ...
                                    { 
                                        ...
                                        {
                                            if ($("#extrabedQty"+selector).val() != "") 
                                            {
                                                extrabed = parseInt($("#extrabedQty"+selector).val());
                                            }
                                            else
                                            {
                                                extrabed = 0;
                                    ...
                                    price = 0, extrabedprice = "", breakfastprice = "", holiday = 0, normal = 0, holidayprice = "", normalprice = "";
                                    for (let k = 0; k < rtypeWithPrice.length; k++) 
                                    {
                                        if ( rtypeWithPrice[k].NAME == rType[j] && rtypeWithPrice[k].ID == rTypeId[j] ) 
                                        {
                                            extrabedprice = extrabed + " x " + rtypeWithPrice[k].EXTRABED_PRICE + " = " + (extrabed * rtypeWithPrice[k].EXTRABED_PRICE);
                                            breakfastprice = breakfast + " x " + rtypeWithPrice[k].BREAKFAST_PRICE + " = " + (breakfast * rtypeWithPrice[k].BREAKFAST_PRICE);
                                            price = price + (extrabed * rtypeWithPrice[k].EXTRABED_PRICE);
                                    ...
                                    $("#roomListSummary").append("\
                                            <div class=\"border border-4 border-dark rounded mt-2 p-3\">\
                                                ...
                                                <div><?= Yii::t('app', 'Aditional') ?> : " + extrabed + " extrabed & " + breakfast + " breakfast</div>\
                                                ...
                                                <div><?= Yii::t('app', 'Extrabed Price') ?> : " + extrabedprice + " </div>\
                ...
                $("#totalPriceText").html(' Total Price : IDR ' + totalPrice);
                $("#formAddRoom").modal('toggle');
            ...
            $("#submitAddBooking").on('click', function()
            {
                ...
                else
                {
                    ...
                    $.ajax({
                        ...
                        url : '<?= Yii::$app->getUrlManager()->createUrl('hotel-booking/booking-add') ?>',
        ...
        //edit form
            ...
            $("#bookingList").on('click', '.editBooking', function()
            {
                ...
                extrabed = bookingAll[selection].EXTRABED_QTY.split(',');
                ...
                for (let i = 0; i < rName.length; i++) 
                {
                    ...
                    price = 0, extrabedprice = "", breakfastprice = "", holiday = 0, normal = 0, holidayprice = "", normalprice = "";
                    for (let j = 0; j < rtypeWithPrice.length; j++) 
                    {
                        if ( rtypeWithPrice[j].NAME == rType[i] && rtypeWithPrice[j].ID == rtypeId[i] ) 
                        {
                            extrabedprice = extrabed[i] + " x " + rtypeWithPrice[j].EXTRABED_PRICE + " = " + (extrabed[i] * rtypeWithPrice[j].EXTRABED_PRICE);
                            breakfastprice = breakfast[i] + " x " + rtypeWithPrice[j].BREAKFAST_PRICE + " = " + (breakfast[i] * rtypeWithPrice[j].BREAKFAST_PRICE);
                            price = price + (extrabed[i] * rtypeWithPrice[j].EXTRABED_PRICE);
                            price = price + (breakfast[i] * rtypeWithPrice[j].BREAKFAST_PRICE);
                            for (let l = 0; l < hari; l++) 
                            {
                                ...
                                {
                                    holiday++;
                                    price = price + parseInt(rtypeWithPrice[j].HOLIDAY_PRICE);
                                }
                                else
                                {
                                    normal++;
                                    price = price + parseInt(rtypeWithPrice[j].REGULAR_PRICE);
                                }
                            }
                            holidayprice = holiday + " x " + rtypeWithPrice[j].HOLIDAY_PRICE + " = " + (holiday * rtypeWithPrice[j].HOLIDAY_PRICE);
                            normalprice = normal + " x " + rtypeWithPrice[j].REGULAR_PRICE + " = " + (normal * rtypeWithPrice[j].REGULAR_PRICE);
                            break;
                        } 
                    }
                    $("#roomListSummaryEdit").append("\
                                            <div class=\"border border-4 border-dark rounded mt-2 p-3\">\
                                                ...
                                                <div><?= Yii::t('app', 'Room Facility') ?> : " + (rtypeFacility[indexFacility].FACILITY_NAME == null ? '<?= Yii::t('app', 'No Facility') ?>': rtypeFacility[indexFacility].FACILITY_NAME) + "</div>\
                                                <div><?= Yii::t('app', 'Aditional') ?> : " + extrabed[i] + " extrabed & " + breakfast[i] + " breakfast</div>\
            ...
            $("#checkoutBtn").on('click', function()
            {
                ...
                $.ajax({
                    ...
                    url : '<?= Yii::$app->getUrlManager()->createUrl('hotel-booking/booking-status-update') ?>',
                    success : function(result)
                    {
                        if (result.errNum == 0) 
                        {
