<div class="site-index my-5">
    <div class="container col-10">
        <div class="fs-3 text-center p-3 fw-bold"><?= Yii::t('app', 'Meeting Room Type') ?></div>
        <div class="">
...
<script>
    $(function()
    {
        ...
        var  selectorView = 0, facilitySelection;
    ...
    //edit logic
        ...
        $("#rtypeList").on("click", ".editRtype", function()
        {
            ...
            if (rtypeList[selectorView].REGULAR_PRICE != null) 
            {
                ...
                $("#breakPriceEdit").val(rtypeList[selectorView].BREAK_PRICE);
                $("#breakfastPriceEdit").val(rtypeList[selectorView].BREAKFAST_PRICE);
                $("#lunchPriceEdit").val(rtypeList[selectorView].LUNCH_PRICE);
                $("#dinnerPriceEdit").val(rtypeList[selectorView].DINNER_PRICE);
                if ($("#inputToggleEdit").is(':checked')) 
                {
                    $("#priceListEdit").show()
                }
        ...
        $("#submitEdit").on('click', function()
        {
            ...
            $.ajax({
                ...
                data : data,
                dataType : 'JSON',
                url : '<?= Yii::$app->getUrlManager()->createUrl('meeting-rtype/edit-rtype') ?>',
        ...
        $("#deleteBtn").on('click', function()
        {
            ...
            $.ajax({
                ...
                data : data,
                dataType : 'JSON',
                url : '<?= Yii::$app->getUrlManager()->createUrl('meeting-rtype/delete-rtype') ?>',
    ...
    //add rtype logic
        ...
        $("#addBtn").on('click',function()
        {
            $("#formAddRtype").removeClass('was-validated');
        })
        ...
        $("#submitAddRtype").on('click', function()
        {
            ...
            else
            {
                ...
                if ($("#inputToggleAdd").is(':checked')) 
                {
                    if ($("#normalPrice").val() == "" || $("#holidayPrice").val() == "" || $("#breakPrice").val() == "" || $("#breakfastPrice").val() == "" || $("#lunchPrice").val() == "" || $("#dinnerPrice").val() == "")
                    {
                        $("#formAddRtype").addClass('was-validated')
                        alert('<?= Yii::t('app', 'All price input must be filled!') ?>');
                        flag = "no";
                ...
                if (flag == "go") 
                {
                    ...
                    $.ajax({
                        ...
                        url : '<?= Yii::$app->getUrlManager()->createUrl('meeting-rtype/add-rtype') ?>',
                        success : function(result)
                        {
                            if (result.errNum == 0) 
                            {
